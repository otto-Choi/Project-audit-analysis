...
> 실제 출력 파일: `data/w5_output/원장_조서_20260429.xlsx`
...
| 항목 | 내용 |
|------|------|
| 입력 | `data/w4_processed/master_gl_clean.csv` |
| 출력 | `data/w5_output/원장_조서_YYYYMMDD.xlsx` (멀티시트) |
| 작업 파일 | `notebooks/w5_excel_export.ipynb` |
...
# 파일 경로
DATA_PATH   = "../data/w4_processed/master_gl_clean.csv"
MASTER_PATH = "../data/w4_processed/account_master.csv"
OUTPUT_DIR  = "../data/w5_output"
